...
public class TriangleTest_BVA {
	...
	public void setUp() throws Exception {
		...
		rightAngledTriangleInvalid = new Triangle(3, 4, 0);
		equilateralTriangleInvalid = new Triangle(0,0,0);
		isoscelesTriangleInvalid = new Triangle(0, 0, 1);
		scaleneTriangleInvalid = new Triangle(0,1,2);
		impossibleTriangleInvalid = new Triangle(0,1, 10);
	}
...
//		impossibleTriangleInvalid = null;
	...
	*/
	...
	public void rightAngleInvalidIsPerimiter() {
		assertEquals(7, rightAngledTriangleInvalid.getPerimeter());
	}

	@Test
	public void rightAngleInvalidIsSideLenght() {
		assertEquals("3,4,0", rightAngledTriangleInvalid.getSideLengths());
	}
	...
	public void equilateralTriangleInvalidPerimeter() {
		assertEquals(0, equilateralTriangleInvalid.getPerimeter());
	}
	@Test
	public void equilateralTriangleInvalidSideLenght() {
		assertEquals("0,0,0", equilateralTriangleInvalid.getSideLengths());
	}
	@Test
	...
	public void scaleneTriangleInvalidisTrue(){
		assertFalse(scaleneTriangleInvalid.isScalene()); //Thinks scalene although impossible
	}
	...
	public void scaleneTriangleInvalidPerimeter(){
		assertEquals(3, scaleneTriangleInvalid.getPerimeter());
	}
	
	@Test 
	public void scaleneTriangleInvalidSideLength(){
		assertEquals("0,1,2", scaleneTriangleInvalid.getSideLengths());
	}
	...
	public void impossibleTriangleInvalidPerimeter(){
		assertEquals(11, impossibleTriangleInvalid.getPerimeter());
	}
	
	@Test 
	public void impossibleTriangleInvalidSideLength(){
		assertEquals("0,1,10", impossibleTriangleInvalid.getSideLengths());
	}
